...
include"koneksi.php";
$e=$_GET['id'];
$edit=mysqli_query($conn, "SELECT * FROM tbl_layanan WHERE id_skck='$e'");
...
<form action="?module=e_skck" method="post" enctype="multipart/form-data">
		...
		<!-- <b>Tempat Lahir : </b><input type="text" name="tmp_lahir" class="form-control" value =" <?php  echo $book['tmp_lahir'];?>"><br> -->
 		...
 		<b>No Telephone : </b><input type="text" name="no_telephone" class="form-control" value =" <?php  echo $book['no_telephone'];?>" ><br>
 		<b>Keperluan : </b><input type="text" name="keperluan" class="form-control" value =" <?php  echo $book['keperluan'];?>" ><br>
 		<b>Kronologi : </b><input type="text" name="kronologi" class="form-control" value =" <?php  echo $book['kronologi'];?>" ><br>

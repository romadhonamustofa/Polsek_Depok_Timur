	...
	<form method="post" class="form-group" action="tambah_skck.php" enctype="multipart/form-data" style="margin-top:20px;">
		...
		<input type="text" name="no_telephone" placeholder="No telephone" class="form-control"><br>
		<input type="text" name="keperluan" placeholder="Keperluan" class="form-control"><br>
		<input type="text" name="kronologi" placeholder="kronologi" class="form-control"><br>

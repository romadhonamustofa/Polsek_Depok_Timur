...
include "koneksi.php"; 
include "tglindo.php"; 
$d = mysql_fetch_array(mysql_query("SELECT * FROM tbl_perijinan where id_perijinan='$_GET[id]'"));
?>
...
<tr>
    <td align="center"><p>Nomor : 00<?php echo "$d[id_perijinan]"; ?>/198/TRANTIB/309.07/VIII/2018</p></td>
</tr> 
</table>

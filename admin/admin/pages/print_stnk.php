...
include "koneksi.php"; 
include "tglindo.php"; 
$d = mysql_fetch_array(mysql_query("SELECT * FROM tbl_stnk where id_stnk='$_GET[id]'"));
?>
...
<tr>
    <td align="center"><p>Nomor : 00<?php echo "$d[id_stnk]"; ?>/198/TRANTIB/309.07/VIII/2018</p></td>
</tr> 
</table>

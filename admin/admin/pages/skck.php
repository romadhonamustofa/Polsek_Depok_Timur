        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">DATA LAYANAN POLSEK DEPOK TIMUR</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
include"koneksi.php";
$no = 1;
$qry_skck = mysqli_query($conn, "SELECT * from tbl_layanan");
?>
...
<a href="?module=input_skck" class="btn btn-success" style="margin-top:20px;"><span class="glyphicon glyphicon-plus"> TAMBAH DATA</span></a>
<?php
@$aksi = $_GET['aksi'];
if($aksi=="input")
{
...
<table class="table table-bordered" style="margin-top:20px;">
	...
	<th style=" background: #E6E6FA;"><center>No Telephone</center></th>
	<th style=" background: #E6E6FA;">Keperluan</th>
	<th style=" background: #E6E6FA;">Kronologi</th>

...
`id_pengunjung` int(12) NOT NULL,
  `kronologi` varchar(30) COLLATE latin1_general_ci NOT NULL,
  `jenis_bank` varchar(20) COLLATE latin1_general_ci NOT NULL,
...
INSERT INTO `tbl_pengunjung` (`id_pengunjung`, `kronologi`, `jenis_bank`, `nama_lengkap`, `tgl_lahir`, `jenis_kelamin`, `alamat`, `agama`, `no_telpon`) VALUES
...
`id_skck` int(12) NOT NULL,
  ...
  `pekerjaan` varchar(30) COLLATE latin1_general_ci NOT NULL,
  `no_telephone` varchar(30) COLLATE latin1_general_ci NOT NULL,
  `keperluan` varchar(30) COLLATE latin1_general_ci NOT NULL,
  `kronologi` varchar(40) COLLATE latin1_general_ci NOT NULL,
  `keterangan` varchar(20) COLLATE latin1_general_ci NOT NULL,
  `masa` varchar(20) COLLATE latin1_general_ci NOT NULL
...
INSERT INTO `tbl_skck` (`id_skck`, `nama`, `jenis_kelamin`, `kebangsaan`, `agama`, `tgl_lahir`, `tmp_lahir`, `alamat`, `pekerjaan`, `no_telephone`, `keperluan`, `kronologi`, `keterangan`, `masa`) VALUES
...
-- --
-- ALTER TABLE `tbl_sim`
-- MODIFY `id_sim` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `tbl_skck`
--
ALTER TABLE `tbl_skck`
MODIFY `id_skck` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=227;
--
